...
![에디터 와이어프레임](/assets/img/posts/2023-08-28-20-17-38.png)
...
![디자인 교체 Flow 와이어프레임](/assets/img/posts/2023-08-28-20-20-18.png)
...
![편집 플로우 그래프](/assets/img/posts/2023-08-27-23-03-36.png)
...
![편집 플로우 그래프 (데이터 노드가 추가 된 버전)](/assets/img/posts/2023-08-27-23-07-51.png)
...
![저장 플로우 그래프](/assets/img/posts/2023-08-27-23-28-50.png)

단순하게 생각했을 때 [저장]이라는 행위를 처리하기 위해 필요한 데이터는 현재 작업물에 필요한 데이터 뿐입니다.

![저장 플로우 그래프 (데이터 노드가 추가 된 버전)](/assets/img/posts/2023-08-27-23-30-37.png)
...
![여러 Case에 대한 저장 로직](/assets/img/posts/2023-08-27-23-32-43.png)
...
![컴포넌트 그래프](/assets/img/posts/2023-08-27-23-33-55.png)
...
![컴포넌트 그래프 (데이터 노드가 추가 된 버전)](/assets/img/posts/2023-08-27-23-36-54.png)
...
![Taxonomy 로직이 각 컴포넌트 내부에 정의 된 컴포넌트 그래프](/assets/img/posts/2023-08-27-23-38-24.png)
...
![Taxonomy 로직을 Context에 위임한 컴포넌트 그래프](/assets/img/posts/2023-08-27-23-40-41.png)
