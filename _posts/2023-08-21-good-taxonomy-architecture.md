...
![Logomakershop](/assets/img/posts/2023-08-21-11-56-02.png)

위 사진은 [Logomakershop]의 편집 화면입니다.

## 이해를 위한 배경지식

본 포스트에서는 Logomakershop 서비스를 예시로 들기 때문에 우선 해당 서비스의 기능 중 하나를 설명하고 시작하겠습니다.

Logomakershop은 비디자이너도 쉽게 디자인 결과물을 만들 수 있도록 전문적인 디자이너가 만든 템플릿으로 디자인을 시작할 수 있습니다.  
하지만 편집 도중에 단순 변심으로 다른 템플릿으로 변경하고 싶을 수도 있습니다.  
그렇기 때문에 Logomakershop은 작업 도중에도 템플릿을 교체할 수 있는 기능을 지원합니다.
...
![편집 Flow](/assets/img/posts/2023-08-21-11-57-04.gif)
...
![편집 플로우 그래프](/assets/img/posts/2023-08-21-11-58-31.png)
...
![저장 플로우 그래프](/assets/img/posts/2023-08-21-11-59-25.png){: width="500px" }

단순하게 생각했을 때 [저장]이라는 행위를 처리하기 위해 필요한 데이터는 현재 작업물에 필요한 데이터 뿐입니다.

![저장 플로우 그래프 (데이터 노드가 추가 된 버전)](/assets/img/posts/2023-08-21-11-59-42.png)
...
![여러 Case에 대한 저장 플로우 그래프](/assets/img/posts/2023-08-21-12-00-05.png){: width="500px" }
...
![컴포넌트 그래프](/assets/img/posts/2023-08-21-12-00-40.png)
...
![컴포넌트 그래프 (데이터 노드가 추가 된 버전)](/assets/img/posts/2023-08-21-12-01-07.png)
...
![Taxonomy 로직이 각 컴포넌트 내부에 정의 된 컴포넌트 그래프](/assets/img/posts/2023-08-21-12-01-35.png)
...
![Taxonomy 로직을 Context에 위임한 컴포넌트 그래프](/assets/img/posts/2023-08-21-12-02-09.png)
