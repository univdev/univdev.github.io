...
- [목차](#목차)
- [들어가며](#들어가며)
- [요즘 개발하는 서비스란?](#요즘-개발하는-서비스란)
- [DOM 렌더링 엔진의 한계](#dom-렌더링-엔진의-한계)
- [해결 방법](#해결-방법)
  - [자원의 재사용](#자원의-재사용)
- [동일한 인스턴스를 이용한 병렬 처리의 문제점](#동일한-인스턴스를-이용한-병렬-처리의-문제점)
- [병렬 처리 vs 순차 처리](#병렬-처리-vs-순차-처리)
- [마치며](#마치며)
...
![스냅샷 촬영 플로우](/assets/img/posts/2023-08-02-20-17-31.png)
{: width="300" }
...
![인스턴스 재활용의 문제](/assets/img/posts/2023-08-06-23-03-38.png)  
...
```
성능은 아래와 같이 나왔습니다.
![측정 결과](/assets/img/posts/2023-08-06-23-08-01.png)  
